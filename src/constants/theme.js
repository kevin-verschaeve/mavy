 ...
 * - Degrades subtils pour la profondeur
 * - Ombres colorees et douces
 * - Coins arrondis genereux
...
// Couleurs pour les categories (palette variee)
...
export const typography = {
  ...
  // Line heights pour meilleure lisibilite
  lineHeights: {
    tight: 1.2,
    normal: 1.5,
    relaxed: 1.75,
...
export const shadows = {
  ...
  // Ombre coloree pour les elements primaires
  primary: {
    elevation: 4,
    shadowColor: '#6366f1',
    shadowOffset: { width: 0, height: 4 },
